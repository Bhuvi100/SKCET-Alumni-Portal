...
<div>
   <br />
   <br />
   <svg class="wave-top" viewBox="0 0 1439 147" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" style={{ background: "linear-gradient(to right, #2A2A72, #009FFD)" }}>
   ...
   <footer class="bg-blue-600 pt-10 relative z-10" style={{ background: "linear-gradient(to right, #2A2A72, #009FFD)" }}>
    <div class="container mx-auto">
       <div class="flex justify-around">
          ...
          <div class="w-full sm:w-2/3 lg:w-3/12 px-4">
            <div class="w-full mb-10">
               <p class="text-base text-body-color mb-2 text-gray-100 ">
                   Kuniamuthur
                   Coimbatore
                   TamilNadu - 641008
               </p>
               <p class="text-base text-body-color mb-2 text-gray-100 ">
                   Phone: 0422-2678001(7 Lines)
               </p>
               <p class="text-base text-body-color mb-2 text-gray-100 ">
                   FAX: 0422-2678012
               </p>
          ...
          <div class="w-full sm:w-1/2 lg:w-3/12 px-4">
             <div class="w-full mb-10">
                <h4 class="text-gray-100  text-lg font-semibold mb-9">Follow Us On</h4>
