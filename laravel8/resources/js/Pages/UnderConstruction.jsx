                    ...
                    <div class="p-2 flex justify-center items-center">
                        <a
                            ...
                            class={
                                ...
                                (route("dashboard") === window.location.href
                                    ? "bg-blue-100"
                                    : "")
                            }
                        >
                            <img src="/assets/ski_logo.png" class="h-40 w-40" />
                        </a>
                    </div>
                    <h1 class="md:text-7xl text-3xl mx-auto font-extrabold text-white tracking-widest">
                        {" "}
