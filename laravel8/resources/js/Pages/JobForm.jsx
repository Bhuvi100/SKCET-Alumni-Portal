    ...
    <div class="max-w-2xl  mx-auto bg-white p-5 rounded-lg shadow-inner border-solid border-2 border-gray-100">
      ...
      <form onSubmit={handleSubmit} >
         <div class="grid gap-6 mb-6 lg:grid-cols-2 mt-2">
            <div>
               <label for="job_title" class="block mb-2 text-black dark:text-gray-900">Job Title</label>
            ...
            <div>
                <label for="workPlace_type" class="block mb-2 text-black dark:text-gray-900">WorkPlace Type</label>
            ...
            <div>
               <label for="job_location" class="block mb-2 text-black dark:text-gray-900">Job Location</label>
               <input type="text" class="block w-full px-4 py-2 mt-2  bg-white border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none focus:ring" required
            ...
            <div>
                <label for="employment_type" class="block mb-2 text-black dark:text-gray-900">Employment Type</label>
                <select class="block w-full px-4 py-2 mt-2  bg-white border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none focus:ring"
            ...
            <div>
                <label for="tools" class="block mb-2 text-black dark:text-gray-900">Tools</label>
                <input type="text" class="block w-full px-4 py-2 mt-2  bg-white border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none focus:ring" required
                 name='tools'
                 id ='tools'
                 value={data.tools}
         ...
         <div>
                <label for="job_description" class="block mb-2 text-black dark:text-gray-900">Job Description</label>
        ...
        <div>
                <label for="link" class="block mt-2 mb-2 text-black dark:text-gray-900">Link</label>
                <input type="text" class="block w-full px-4 py-2 mt-2  bg-white border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none focus:ring" required
                 name='link'
                 id ='link'
                 value={data.link}
