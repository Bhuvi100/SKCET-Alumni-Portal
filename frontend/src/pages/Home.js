...
<div class="bg-slate-200" >
    <div class="flex h-screen bg-slate-200">
      ...
      <aside class="z-20 hidden w-60 overflow-y-auto md:block flex-shrink-0 bg-slate-200 ml-4 mt-4">
<aside class="w-56 mt-28" aria-label="Sidebar">
   <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded">
   <div class=" mt-2 p-2 flex justify-center ">
       <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none transparent pr-6">
<img src={Logo} class="h-24 w-24"/>
          </a>
        </div>
      <ul class="space-y-2">
         <li class="mt-12">
            <a href="#" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-black hover:text-white dark:hover:bg-blue-600">
               <svg aria-hidden="true" class="w-6 h-6 text-grey-500 transition duration-75  group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>
        ...
        <header class="z-10 py-4  shadow-xs ">
          <div class="container flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
            ...
            <div class="flex w-full mt-1 pt-2 pl-5">
                    ...
                    <img class="inline-block object-cover w-12 h-12 text-white border-2 border-white rounded-full shadow-sm cursor-pointer" src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=2&amp;w=256&amp;h=256&amp;q=80" alt=""/>
                    <img class="inline-block object-cover w-12 h-12 -ml-2 text-white border-2 border-white rounded-full shadow-sm cursor-pointer" src="https://images.unsplash.com/photo-1550525811-e5869dd03032?ixlib=rb-1.2.1&amp;auto=format&amp;fit=facearea&amp;facepad=2&amp;w=256&amp;h=256&amp;q=80" alt=""/>
                    <img class="inline-block object-cover w-12 h-12 -ml-2 text-white border-2 border-white rounded-full shadow-sm cursor-pointer" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=634&amp;q=80" alt=""/>
                    <img class="inline-block object-cover w-12 h-12 -ml-2 text-white border-2 border-white rounded-full shadow-sm cursor-pointer" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=2.25&amp;w=256&amp;h=256&amp;q=80" alt=""/>
                </div>
          </div>
        </header>
        <header class="z-10 py-4  shadow-xs ">
...
<div class="container p-2 mx-auto">
  ...
  <h2 class="text-black text-lg font-semibold">Job Offers</h2>
    ...
    <div class="flex items-center justify-center">
  <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">View Openings</button>
    </div>
</div>
...
<a href="#" class="mt-3 block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md">
   <div class="grid grid-cols-2">
    <div>
    <p class="font-medium text-black">Are you a Club / Committee / Department ?</p>
    </div>
    <div>
    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mt-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create Account</button>
    </div>
