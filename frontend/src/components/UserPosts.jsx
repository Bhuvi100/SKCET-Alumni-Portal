        ...
        <div class="bg-white shadow rounded-lg pb-4 mt-7">
                  ...
                  <div class="flex w-full border-t border-gray-100">
                      <div class="mt-3 mx-5 flex flex-row text-xs">
                          <div class="flex text-gray-700 font-normal rounded-md mb-2 mr-4 items-center" onClick = {() => setCom(true)}>Comments:<div class="ml-1 text-gray-400 text-ms"> 30</div></div>
