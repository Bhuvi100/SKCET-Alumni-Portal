...
const IndexFooter = () => {
  return (
    <div>
        <br />
        <br />
        <footer class="px-4 divide-y" style={{ background: "linear-gradient(to right, #2A2A72, #009FFD)" }}>
	<div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div class="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
				<span class="self-center text-4xl font-semibold text-gray-50"> SKCET LinkUP</span>
			</a>
		</div>
		<div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div class="space-y-3">
				<h3 class="tracking-wide uppercase text-gray-50 text-2xl">LINK 1</h3>
				<ul class="space-y-1">
					<li className='text-gray-50'>
						<a rel="noopener noreferrer" href="#">X</a>
					</li>
					<li className='text-gray-50'>
						<a rel="noopener noreferrer" href="#">Y</a>
					</li>
					<li className='text-gray-50'>
						<a rel="noopener noreferrer" href="#">Z</a>
					</li>
					<li className='text-gray-50'>
			...
			<div class="space-y-3">
				<div class="uppercase text-gray-50 text-2xl">Social media</div>
