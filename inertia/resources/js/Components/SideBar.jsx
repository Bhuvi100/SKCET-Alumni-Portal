        ...
        <div>
            <div className="fixed  top-8 lg:top-40 left-4">
                ...
                </div>
                {
                    ...
                    <div  class={`z-20 w-60 overflow-y-auto md:block flex-shrink-0 bg-slate-200 ml-4 mt-4 flex-row flex-nowrap overflow-hidden shadow-xl transition-all duration-300 ${
                            showSidebar
