        ...
        <div>
            <div className="">
                <div className="md:hidden">
                    <button
                        type="button"
                        class="text-black hover:bg-white md:hidden font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 "
                    ...
                    >
                        <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded">
                            <div class=" mt-2 p-2 flex justify-center ">
                                ...
                                >
                                    <img src="/assets/logo.png" class="h-24 w-24" />
                                </a>
                            </div>
                            <ul class="space-y-2">
                                <li class="mt-12">
