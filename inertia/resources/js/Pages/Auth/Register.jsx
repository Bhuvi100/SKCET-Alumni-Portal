...
<form >
  ...
  <div class="grid gap-6 mb-6 lg:grid-cols-2 mt-2">
  <div>
        <label for="city" class="block mb-2 text-black dark:text-gray-900">City and State</label>
        <input type="text" class="bg-white border border-gray-300 text-gray-900 text-medium rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:focus:ring-blue-500 dark:focus:border-blue-500" required/>
     </div>
     <div>
...
*/}
  ...
  <div class="flex items-center justify-center">
     <button href="#" onClick = {(e) => setNext(1)} class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Next</button>
  </div>
</form>
</div> :
<InfoForm next = {setNext} />
  } 
