                    ...
                    <main className="pb-16 overflow-y-auto">
                        <div className="block md:grid md:grid-flow-row-dense md:grid-cols-3">
                            <div className="col-span-2">
                                <div className="pt-10">
                                    <form className="bg-white shadow rounded-lg mb-5 p-4 w-full md:w-full">
                                        ...
                                        <footer className="flex justify-between mt-2">
                                            ...
                                            <button
                                                className="flex items-center py-2 px-4 rounded-lg text-sm bg-blue-600 text-white shadow-lg                 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800
  "
                                            >
                                                Post
                                                <svg
                                ...
                                <section className="max-w-4xl mx-auto sm:px-6 lg:px-4 bg-white">
                                ...
                                <div className=" mt-5">
                                    <div className="container m-auto px-6 text-gray-500 md:px-12 xl:px-0 mb-5 bg-slate-200">
                                        <div className="mx-auto grid gap-6 md:w-3/4 lg:w-full lg:grid-cols-3">
                                            <div className="bg-white rounded-2xl shadow-xl px-8 py-12 sm:px-12 lg:px-8 h-64">
                                                <div className=" space-y-4">
                                                    ...
                                                    <p>
                                                        Obcaecati, quam?
                                                        Eligendi, nulla numquam
                                                        natus laborum porro at
                                                        cum, consectetur us.
                                                    </p>
                                                    <a
                                                        href="#"
                                ...
                                <div className="bg-white shadow rounded-lg pb-4 mt-7">
                                    ...
                                    <div className="text-gray-500 text-sm mb-6 mx-3 px-2">
                                        Love and gratitude to both The Prime
                                        Minister, The Honorable Mia Amor Mottley
                                        and our President, Her Excellency The
                                        Most Honorable Dame Sandra Mason for
                                        trusting me with this honor!
                                    </div>
                                            ...
                                            <div className="row-span-2 p-6 border border-gray-100 rounded-xl bg-gray-50 text-center sm:p-8">
                                                <div className="h-full flex flex-col justify-center space-y-4">
                                                    <p className="text-gray-600 md:text-xl">
                                                        ...
                                                        NEWSSSSSSSS Lorem ipsum
                                                        dolor sitt provident,
                                                        omnis ut, sapiente
                                                        voluptates veritatis cum
                                                        deleniti repudiandae ad
                                                        doloribus.{" "}
                                                        <span className="font-serif">
                                                            "
                                                        </span>
                            ...
                            <div className="hidden md:block lg:block py-8 rounded-lg sticky h-4 ml-4 mr-4 mt-2">
                                <div className="max-w-2xl mx-auto">
                                    <form>
                                        <div className="relative">
                                            ...
                                            <input
                                                type="search"
                                                className="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg dark:bg-white"
                                                placeholder="Search...."
                                            />
                                            <button
                                                type="submit"
                                ...
                                <div className="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md mt-2">
                                ...
                                <a
                                    href="#"
                                    className="mt-3 block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md "
                                >
                                    <h5 className="mb-2 text-xl font-bold tracking-tight text-black">
                                        Mentorship Program
                                    </h5>
                                    <p className="font-medium">
                                        Be a mentor to provide support and
                                        feedback or Register as a mentee to seek
                                        help and career guidance from your
                                        alumni.
                                    </p>
                                    <div className="flex items-center justify-center">
                                        <button
                                ...
                                <div className="max-w-2xl mx-auto mt-3">
                                    <div className="p-4 max-w-md bg-white rounded-lg border shadow-md sm:p-8 border-gray-200">
                                ...
                                <div className="flex flex-col items-center justify-center mt-3">
                                    <div className="w-full max-w-md px-7 py-5 mx-auto bg-white rounded-2xl shadow-md border border-gray-100">
                                  ...
                                  transition-all duration-150 delay-100"
                                                        >
                                                            ...
                                                            <button
                                                                className="absolute transition duration-500 bg-white
