...
const Chats = ({ user, auth, errors }) => {
  ...
  return (
    ...
    <div class="flex flex-row h-full w-full overflow-x-hidden">
      {!selectedChat && <div class="flex flex-col py-8 pl-6 pr-2 w-full bg-white flex-shrink-0 ">
        ...
        <div class="flex flex-col mt-8">
          <div class="flex flex-row items-center justify-between text-xs">
            <span class="font-bold mb-2">Active Conversations</span>
          ...
          <div class="flex flex-col space-y-1 mt-4 -mx-2 h-48 overflow-y-auto">
            ...
            >
              ...
              <div class="ml-2 text-sm font-semibold" onClick={() => setSelectedChat(!selectedChat)}>Philip Tucker</div>
            </button>
            <button
              class="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2"
            >
...
}
      {
        ...
        <button
              ...
              <h1 class="ml-2 font-bold text-2xl mb-3">Philip Tucker</h1>
        </div>
